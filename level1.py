...
Коротко про дизайн:
  ...
  • Щоб не «морозилося»:
      – Графіки за замовчуванням ЗБЕРІГАЮТЬСЯ (а не показуються вікном).
      – Для ЛР використовуємо швидкий режим (solver='newton-cg', tol=1e-3), max_iter=600.
      – Опціонально можна увімкнути ще швидший SGD-режим (—lr-solver sgd).
"""
